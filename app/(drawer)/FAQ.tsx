    ...
    questions: [
      {
        ...
        answer:
          "Eine Reinigung umfasst Staubsaugen, Wischen, Bad- und Küchenreinigung sowie Müllentsorgung.",
      },
      {
        id: "2",
      ...
      },
      {
        ...
        answer:
          "Bitte räumen Sie Wertsachen weg und teilen Sie spezielle Wünsche im Voraus mit.",
      },
      {
        id: "4",
        question: "Muss ich Reinigungsmaterial bereitstellen?",
        answer:
          "Nein, AppClean stellt alle notwendigen Materialien und Reinigungsmittel bereit.",
      },
      {
        id: "5",
        question: "Was ist wenn bei der Reinigung etwas übersehen wurde?",
        answer:
          "Bitte melden Sie dies innerhalb von 24 Stunden, wir kümmern uns umgehend darum.",
      },
      {
        id: "6",
        question:
          "Was passiert wenn während einer Reinigung etwas kaputt geht?",
        answer:
          "Schäden werden von AppClean geprüft und gegebenenfalls ersetzt, bitte melden Sie es sofort.",
      },
    ],
  },
  {
    ...
    questions: [
      {
        ...
        answer:
          "Der Preis basiert auf der Wohnungsgröße, Reinigungsart und Häufigkeit.",
      },
      {
        id: "8",
      ...
      },
      {
        ...
        answer:
          "Zahlung erfolgt per Kreditkarte oder App nach Abschluss der Reinigung.",
      },
      {
        id: "11",
    ...
    questions: [
      {
        ...
        answer:
          "Nein, aber Zugang muss gewährleistet sein, z.B. durch einen Schlüssel.",
      },
      {
        id: "14",
        question: "Um wieviel Uhr kommt die Reinigungskraft?",
        answer:
          "Zwischen 8:00 und 16:00, Sie erhalten einen Zeitfenster-Vorschlag.",
      },
      {
        id: "15",
      ...
      },
      {
        ...
        answer:
          "Reinigungen an Feiertagen sind auf Anfrage möglich, mit Aufpreis.",
      },
      {
        id: "20",
        question: "Wer kommt für die Fahrtkosten auf?",
        answer:
          "Fahrtkosten sind im Preis enthalten, bei Ausnahmefällen wird das separat kommuniziert.",
      },
    ],
  },
  {
    ...
    questions: [
      {
        ...
        answer:
          "AppClean ist zertifiziert und alle Mitarbeiter werden überprüft.",
      },
      {
        id: "22",
        question: "Wie unterscheidet sich AppClean von anderen Diensten?",
        answer:
          "Mit dem 4-Farb-System und flexiblen Buchungsoptionen bieten wir höchste Standards.",
      },
      {
        id: "23",
