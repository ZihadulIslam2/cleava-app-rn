  ...
  return (
    <SafeAreaView style={styles.container}>
      ...
      <ScrollView style={styles.content}>
        ...
        <Text style={styles.bulletText}>
          • Weil Reinigungsservice Verwaltungs GmbH
        </Text>
        <Text style={styles.bulletText}>
          • vertreten durch die Geschäftsführer Gunter Weil und
        </Text>
        ...
        <Text style={styles.bulletTextLast}>
        ...
        <Text style={styles.bulletTextLast}>
          {' '}
          Umsatzsteuergesetz: DE294423504
        </Text>
